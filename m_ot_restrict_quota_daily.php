...
try {
    ...
    $table_source = 'm_ot_restrict_quota_daily';
    $table_target = 'Hris_MOTRestrictQuotaDaily';
    $column_primary = 'mk_nopeg';
...
";
    ...
    while ($offset < $total_data) {
        ...
        // Fetch data per batch based on limit from MySQL
        ...
        $upsertQuery = "
            ...
            ON target.[$column_primary] = source.[$column_primary]
            WHEN MATCHED THEN
                UPDATE SET
